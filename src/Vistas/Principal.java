...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenu2.setText("Tarjeta Diaria");
        jMenu2.setName("jMenu2"); // NOI18N
        jMenuBar1.add(jMenu2);

        jMenu3.setText("Registro Ventas");
        jMenu3.setName("jMenu3"); // NOI18N

        jMenuItem3.setText("Tarjetas Diarias");
        ...
        jMenuItem4.setText("Recibos de Venta");
        ...
        jMenu4.setText("Sindicato");
        jMenu4.setName("jMenu4"); // NOI18N

        jMenuItem5.setText("Registro de aportes al sindicato");
